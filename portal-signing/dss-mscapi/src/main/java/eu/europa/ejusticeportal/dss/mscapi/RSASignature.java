...
abstract class RSASignature extends java.security.SignatureSpi
{
        ...
        throws InvalidKeyException
    {
        ...
        if ((key instanceof eu.europa.ejusticeportal.dss.mscapi.RSAPublicKey) == false) {
            ...
            publicKey = (eu.europa.ejusticeportal.dss.mscapi.RSAPublicKey) key;
        }
    ...
    protected void engineInitSign(PrivateKey key) throws InvalidKeyException
    {
        ...
        if ((key instanceof eu.europa.ejusticeportal.dss.mscapi.RSAPrivateKey) == false) {
            throw new InvalidKeyException("Key type not supported");
        }
        privateKey = (eu.europa.ejusticeportal.dss.mscapi.RSAPrivateKey) key;
