 ...
 *
 */
public class EnumBasedCodeException extends CodeException {
     ...
     * @param objects
     */
    public EnumBasedCodeException(String message, Throwable cause, Enum<?> code, Object... objects) {
     ...
     * @param objects
     */
    public EnumBasedCodeException(Throwable cause, Enum<?> code, Object... objects) {
        super(code.name() + " " + Arrays.asList(objects), cause);
        this.code = code;
        this.objects = null;
    }
     ...
     * @param objects
     */
    public EnumBasedCodeException(Enum<?> code, Object... objects) {
        super(code.name() + " " + Arrays.asList(objects));
        this.code = code;
        this.objects = null;
    }
