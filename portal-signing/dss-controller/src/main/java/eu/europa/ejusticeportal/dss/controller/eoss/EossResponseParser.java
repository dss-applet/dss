 ...
 */
public interface EossResponseParser {

     /**
      * Parse the response from an external online signature service
      * @param s the response string
      * @return the parsed response
      */
     EossResponse parseResponse(String s);
}
