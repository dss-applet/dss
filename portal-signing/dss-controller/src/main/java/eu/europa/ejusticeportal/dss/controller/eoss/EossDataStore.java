...
/**
 * Defines the data store for the External Online Signature Service. This keeps the request/response for the 
 * EOSS
 *  
 ...
 */
public interface EossDataStore {
     ...
     * @return the response
     */
    EossResponse getResponse(String token);
    
    /**
     * Put the response in the store
     * @param token the key
     * @param response the responses
     */
    void setResponse(String token, EossResponse response);
