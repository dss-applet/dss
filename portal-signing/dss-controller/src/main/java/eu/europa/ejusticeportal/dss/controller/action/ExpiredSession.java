...
/**
 *
 * Handles an expired session for the Ajax requests
 *
 * <p>
 ...
 * Developments</a>
 */
public class ExpiredSession extends SigningAction {

    @Override
    protected Object getResponseObject(final PortalFacade portal, final HttpServletRequest request, final Object o) {
        throw new SigningBusinessException(MessagesEnum.dss_applet_message_session_expired);
    }
