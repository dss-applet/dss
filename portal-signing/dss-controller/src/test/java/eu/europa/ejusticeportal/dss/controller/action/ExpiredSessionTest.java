...
public class ExpiredSessionTest {
     ...
     * @throws Exception
     */
    @Test(expected = SigningBusinessException.class)
    public void expiredSessionTest() throws Exception {
        new ExpiredSession().getResponseObject(null, null, null);
    }
}
