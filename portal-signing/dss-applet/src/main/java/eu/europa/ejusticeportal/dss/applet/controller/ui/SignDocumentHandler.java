...
import eu.europa.ejusticeportal.dss.applet.model.action.SigningAction;
import eu.europa.ejusticeportal.dss.common.exception.CodeException;

/**
 * 
 * Handles the event that requires the document to be signed online.
 * 
 * <p>
 ...
 */
public class SignDocumentHandler implements UIEventHandlerDelegate {
