...
/**
 * 
 * Handles the UI event indicating that the applet has started.
 *  
 ...
 */
public class AppletStartedHandler implements UIEventListenerDelegate{    
    /**
     * Handle the event
