 ...
 */
public final class LoggingHome {

    private static volatile LoggingHome instance;
    private LoggingHome(){
     ...
     * @return the instance
     */
    public static LoggingHome getInstance(){
        if (instance == null){
            instance = new LoggingHome();
        }
        return instance;
    }
     ...
     * @return the logger
     */
    public DssLogger getLogger(String name){
        return  DssLogger.getLogger(name);
    }
