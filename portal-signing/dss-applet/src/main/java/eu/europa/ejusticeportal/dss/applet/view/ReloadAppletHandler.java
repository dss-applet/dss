...
/**
 * 
 * Handles the UI event to reload the applet
 *  
 ...
 */
public class ReloadAppletHandler implements UIEventListenerDelegate{
    ...
    public void doHandle(Object event) {
    	...
    	UIControllerHome.getInstance().getUiController().eval(UIFunction.reloadApplet);
    }
