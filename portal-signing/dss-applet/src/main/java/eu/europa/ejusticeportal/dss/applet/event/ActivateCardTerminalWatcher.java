...
/**
 * An event that will activate or deactivate the {@link CardTerminalWatchService}.
 *  
 ...
 */
public class ActivateCardTerminalWatcher {

    private boolean active;
    public ActivateCardTerminalWatcher(boolean active){
        this.active = active;
    }
    /**
     * @return the active
