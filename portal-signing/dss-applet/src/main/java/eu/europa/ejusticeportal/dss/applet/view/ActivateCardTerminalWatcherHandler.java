...
import eu.europa.ejusticeportal.dss.applet.model.service.CardTerminalWatchServiceHome;

/**
 * Turns the card terminal watcher on or off
 *  
 ...
 */
public class ActivateCardTerminalWatcherHandler implements UIEventListenerDelegate {

    /* (non-Javadoc)
     * @see eu.europa.ejusticeportal.dss.applet.view.UIEventListenerDelegate#doHandle(java.lang.Object)
     */
    public void doHandle(Object event) {
        CardTerminalWatchServiceHome.getInstance().activate(((ActivateCardTerminalWatcher)event).isActive());
    }
}
