...
/**
 * 
 * Handles the change of selected certificate event.
 * 
 * <p>
 ...
 */
public class ChangeCertificateHandler implements  UIEventHandlerDelegate {
    ...
    public void doHandle(UIEvent e, String arg) throws CodeException {
        Event.getInstance().fire(new CertificateSelected());
