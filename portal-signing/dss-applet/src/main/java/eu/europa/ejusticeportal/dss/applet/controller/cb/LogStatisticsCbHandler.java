...
/**
 * 
 * Handle the callback of the upload of the signature information.
 *  
 ...
 */
public class LogStatisticsCbHandler extends AbstractCbHandler {
    
    private static final DssLogger LOG = DssLogger.getLogger(LogStatisticsCbHandler.class.getSimpleName());
    /**
     * Handle the callback
     * @param the callback XML
     */
    public void doHandle(String xml) throws CodeException {
        LOG.log(Level.FINE,"Statistics have been properly uploaded.");
    }
    /**
     * Get the label for the handler
     */
    public String getLabel(){
        return "Statistics log receipt";
    }
}
