...
/**
 * Action that performs the refresh of the certificates.
 *
 ...
 * Developments</a>
 */
public class RefreshCertificateList extends AbstractPrivilegedExceptionAction {

    @Override
    protected void doExec() throws CodeException {
        Event.getInstance().fire(new CertificatesRefreshed(TokenManager.getInstance().getCertificateNames()));
    }
}
