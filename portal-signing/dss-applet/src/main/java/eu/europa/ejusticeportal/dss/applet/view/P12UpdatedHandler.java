...
/**
 * 
 * Handles the UI event setting the PKS12 certificate store path
 *  
 ...
 */
public class P12UpdatedHandler implements UIEventListenerDelegate{
    ...
    public void doHandle(Object event) {
        /*
         * Update the path value of the PKCS12 file on the UI.
         */
        P12Updated e = (P12Updated) event;
        UI.setP12FilePath(e.getFilePath());
