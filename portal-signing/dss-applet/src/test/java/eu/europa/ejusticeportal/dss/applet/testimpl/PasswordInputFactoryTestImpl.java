...
/**
 * The test implementation of PasswordInputFactory
 *
 ...
 * Developments</a>
 */
public class PasswordInputFactoryTestImpl implements PasswordInputFactory {

    /**
     * @return A prefilled password callback
     */
    public PasswordInputCallback getPasswordInput(SignatureTokenType api,String cardDescription) {
        return new PrefilledPasswordCallback("password".toCharArray());
    }
